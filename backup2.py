...
class Fukuro_Dynamic:
    def __init__(self, start_point : list[int], end_point : list[int], 
                 robot_coordinate : list[int],  smooth : int, is_dribble : bool):
        self.start_point = start_point
        self.end_point = end_point
        self.robot_coordinate = robot_coordinate
        self.smooth = smooth
        self.is_dribble = is_dribble
    ...
    def chasing_ball(self):
        """
            Gunakan fungsi ini untuk mengejar bola
        """
        try:
            shortest_path = self.dijkstra_voronoi(self.end_point)
    ...
    def attacking(self):
        """
            Gunakan fungsi ini untuk melakukan attacking 
        """
        global_curve_points = {}
    ...
    def main(self):
        """
            Gunakan fungsi ini untuk menjalankan Fukuro_Dynamic
        """
        if self.is_dribble:
            try: 
                curve_points, control_points, length = self.chasing_ball()
                return curve_points, control_points, length
            except:
                pass
        else:
            try: 
                curve_points, control_points, length = self.attacking()
                return curve_points, control_points, length
            except:
                pass